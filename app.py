...
def build_sidebar():
    ...
    tickers = st.multiselect(label="Selecione as Empresas", options=ticker_list, placeholder='Ativos')
...
def build_main(tickers, prices):
    ...
    for t in prices.columns:
        ...
        c.subheader(t, divider="violet")
        colA, colB, colC = c.columns(3)
        if t == "portfolio":
            colA.image("Imagens/compras.png")
        elif t == "IBOV":
            colA.image("Imagens/brasilia.png")
        elif t == "Markowitz":
            colA.image("Imagens/tecnologia.png")
        else:
